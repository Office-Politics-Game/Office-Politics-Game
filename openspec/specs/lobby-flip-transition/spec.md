# lobby-flip-transition Specification

## Purpose

Define how top-level route component identity preserves the Lobby instance across child-route navigation so bidirectional flip transitions, reduced-motion behavior, and the existing result-page transition remain stable.
