...
test('game view provides exactly two default hand cards through the stage', async () => {
  ...
  assert.match(gameViewSource, /CardBG_CEO@2x\.png/)
  assert.match(gameViewSource, /CardFrame_CEO@2x\.png/)
  assert.match(gameViewSource, /CardBG_Advisor@2x\.png/)
  assert.match(gameViewSource, /CardFrame_Advisor@2x\.png/)
