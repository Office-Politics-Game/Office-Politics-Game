# hand-before-draw-guard Specification

## Purpose

Define the frontend hand and deck interaction guards that prevent blocked actions from starting and show lightweight hover feedback.
