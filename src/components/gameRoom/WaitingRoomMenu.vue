...
<template>
  ...
  >
    ...
    >
      ...
      >
        <span
          class="waiting-room-content pointer-events-none flex h-full w-full flex-col items-center text-[#282623]"
        >
          <img
          ...
          <span class="waiting-room-copy block w-full">
            <span
              class="waiting-room-title block font-black leading-none text-[#2d2b29]"
            >
              {{ action.title }}
            </span>
            <span
              class="waiting-room-desc block font-sans font-bold leading-relaxed text-[#3d3934]"
            >
              <span
